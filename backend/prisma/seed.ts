...
async function main() {
  ...
  const pizza = await prisma.products.upsert({
    ...
    create: {
      ...
      price: 12.99,
      image: '/src/uploads/products/pizza.jpg',
    },
  });
  ...
  const burger = await prisma.products.upsert({
    ...
    create: {
      ...
      price: 9.99,
      image: '/src/uploads/products/cheeseburger.jpg',
    },
  });
  ...
  const coffee = await prisma.products.upsert({
    ...
    create: {
      ...
      price: 3.50,
      image: '/src/uploads/products/espresso.webp',
    },
  });
  ...
  const juice = await prisma.products.upsert({
    ...
    create: {
      ...
      price: 4.00,
      image: '/src/uploads/products/orangeJuice.jpg',
    },
  });
  ...
  await prisma.images.upsert({
    ...
    create: {
      productId: pizza.id,
      url: '/src/uploads/products/pizza.jpg',
    },
  });
  ...
  await prisma.images.upsert({
    ...
    create: {
      productId: burger.id,
      url: '/src/uploads/products/cheeseburger.jpg',
    },
  });
  ...
  await prisma.images.upsert({
    ...
    create: {
      productId: coffee.id,
      url: '/src/uploads/products/espresso.webp',
    },
  });
  ...
  await prisma.images.upsert({
    ...
    create: {
      productId: juice.id,
      url: '/src/uploads/products/orangeJuice.jpg',
    },
  });
